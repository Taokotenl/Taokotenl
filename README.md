...
local Window  = Library.CreateLib(" SHADOW DIAMOND HUB V2", "Serpent")
...
local Section = Tab:NewSection("added safe place on Scripts tab")
local Section = Tab:NewSection("added XRay on Scripts tab")
local Section = Tab:NewSection("added Speed on Scripts tab")
local Section = Tab:NewSection("addeed inf jump on Scripts tab")
